...
/* harmony export */ });
/* unused harmony exports load_goatcounter, sort_universal_number, sort_universal_string, getCookie, setCookie, indexed_db */
...
;// CONCATENATED MODULE: ./js/missile_ballistics.js
...
async function main() {
	...
	async function run_live_mode() {
		while (live_mode.checked === true) {
			...
			if (stop - start < 40) {
				await (0,util/* sleep */._v)(40 - stop - start);
			}
		}
	}
