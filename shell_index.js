...
/* harmony export */ });
/* unused harmony exports load_goatcounter, sleep, set_value_enter, input_manager, getCookie, setCookie, indexed_db */
...
;// CONCATENATED MODULE: ./js/shell_index.js
...
async function main() {
	...
	for (const element of document.getElementsByClassName("sortable_str")) {
		element.addEventListener("click", event => {
			;(0,util/* sort_universal_string */.P5)(event, "tbody")
		})
	}
