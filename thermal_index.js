...
/* harmony export */   P5: () => (/* binding */ sort_universal_string),
/* harmony export */   U2: () => (/* binding */ set_value_enter)
/* harmony export */ });
/* unused harmony exports load_goatcounter, sort_universal_number, sleep, getCookie, setCookie, indexed_db */
...
;// CONCATENATED MODULE: ./js/thermal_index.js
...
async function main() {
	...
	(0,util/* input_manager */.G5)("Select vehicle class");

	document.getElementById("dropdown").addEventListener("submit", function () {
		(0,util/* set_value_enter */.U2)();
	});
	...
	for (const element of document.getElementsByClassName("sortable_str")) {
		element.addEventListener("click", event => {
			(0,util/* sort_universal_string */.P5)(event, "table_contents")
		})
	}
