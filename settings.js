...
/* harmony export */   bm: () => (/* binding */ indexed_db)
/* harmony export */ });
/* unused harmony exports load_goatcounter, sort_universal_number, sort_universal_string, sleep, set_value_enter, input_manager, getCookie, setCookie */
...
async function main() {
	let openRequest = window.indexedDB.open((0,util/* indexed_db */.bm)(), 1);
