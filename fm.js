...
/* harmony export */   Dl: () => (/* binding */ get_indicators),
/* harmony export */   Dy: () => (/* binding */ get_state),
/* harmony export */   f7: () => (/* binding */ set_dialog_ready)
/* harmony export */ });
...
// EXTERNAL MODULE: ./js/localhost.js
var localhost = __webpack_require__(599);
;// CONCATENATED MODULE: ./js/fm.js
...
async function main() {
	...
	let timeout = 1000;
	(0,localhost/* set_dialog_ready */.f7)();

	let interval = setInterval(async function () {
		const indicators_data = await (0,localhost/* get_indicators */.Dl)();
		const state_data = await (0,localhost/* get_state */.Dy)();
